...
public class OrangeHRM {
	...
	{   System.setProperty("webdriver.chrome.driver", "C:\\Users\\SNEHA\\eclipse-workspace\\Orange_HRM\\Driver\\chromedriver.exe");
...
///Thread.sleep(2000);
		...
		public void deleteEmployee() throws InterruptedException
		{
			...
			//enter employee name
			driver.findElements(By.tagName("input")).get(1).sendKeys("Smith");
